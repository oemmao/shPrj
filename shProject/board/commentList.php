...
$cmt_sql = "select * from commentInfo  where board_idx='$idx' order by idx desc";
$cmt_result = mysqli_query($con, $cmt_sql);
$cmt_row_total = mysqli_num_rows($cmt_result);
...
//ceil 소수점 올림 함수
$cmt_total = ceil($cmt_row_total/$cmt_list); //총 페이지 수
