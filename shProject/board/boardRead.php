...
$sql = "select idx, member_idx, subject, content, creatDate, userID from boardInfo join memberInfo on boardInfo.member_idx = memberInfo.id where idx='$idx'";
        ...
        <article class="col-xs-10 article_line">
            <div>
                ...
                <tr class="read_table_tr_size">
					...
					<td class="col-xs-1 text-center">0</td>
                </tr>
				<tr>
